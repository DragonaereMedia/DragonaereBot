module.exports = {
  ...
  async execute(client, interaction) {
    ...
    return client.say.successMessage(interaction, `${queue.getFiltersEnabled().includes(`${filterName}`) ? `Bassboost filter level set to \`${level}\`` : "Disabled the bassboost filter"}.`);
  }
};